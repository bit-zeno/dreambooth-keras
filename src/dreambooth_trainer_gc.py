...
from src.checkpointing import get_diffusion_sub_models, get_recompute_models, forward_pass_with_recompute
...
class DreamBoothTrainer(tf.keras.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.sub_diffusion_models = get_diffusion_sub_models(diffusion_model)
    ...
    def train_step(self, inputs):
        ...
        recompute_diffusion_models = get_recompute_models(self.sub_diffusion_models)
        ...
        with tf.GradientTape() as tape:
            ...
            model_pred = forward_pass_with_recompute(recompute_diffusion_models, timestep_embedding, noisy_latents, texts)
        ...
        if self.train_text_encoder:
            ...
            trainable_vars = [item for s in self.sub_diffusion_models for item in s.trainable_variables]
